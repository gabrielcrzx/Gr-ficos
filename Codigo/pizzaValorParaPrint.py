...
texttemplate='%{label}<br>%{percent}<br>R$ %{value:.2f} Bi',
textposition='outside', # Coloca tudo para fora da pizza
...
showlegend=False,
margin=dict(t=50, b=50, l=50, r=50) # Ajusta as margens para os balões não sumirem
)
fig.show()
